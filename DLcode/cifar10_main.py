...
_DEPTH = 3
_NUM_CLASSES = 10
_NUM_DATA_FILES = 5 #what this use for?
...
def parse_record(raw_record):
  ...
  # and then to one-hot.
  # tf.cast is a type conversion function
  ...
  # float32. A transpose, default is [0, 1, 2]
...
def preprocess_image(image, is_training):
  ...
  if is_training:
    ...
    # which means 8 pixels increament for both width adh height
